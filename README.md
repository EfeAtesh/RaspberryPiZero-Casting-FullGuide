...
2. [System Requirements Specification (SRS)](#2-system-requirements-specification-srs)
3. [System Architecture and Subsystem Decomposition](#3-system-architecture-and-subsystem-decomposition)
4. [Step-by-Step Installation and Deployment Guide](#4-step-by-step-installation-and-deployment-guide)
5. [Performance Engineering & Quality Optimization Specification](#5-performance-engineering--quality-optimization-specification)
6. [Operational Manual and Verification Procedures](#6-operational-manual-and-verification-procedures)
7. [Fault Analysis and Troubleshooting Matrix](#7-fault-analysis-and-troubleshooting-matrix)
8. [Appendix: Quick Installation Guide (3-Minute Setup)](#8-appendix-quick-installation-guide-3-minute-setup)
...
### 1.2 System Objectives & Quality Priorities
...
### 2.2 Software & Operating System Specification
...
## 3. System Architecture and Subsystem Decomposition
...
### 3.2 Protocol Sequence Flow (RTSP M1 to M7 Handshake)
...
## 4. Step-by-Step Installation and Deployment Guide

### 4.1 Phase 1: Storage Medium Preparation
...
### 4.2 Phase 2: Post-Boot Storage and Package Provisioning
...
### 4.3 Phase 3: Hardware Userland and Core Player Compilation
...
### 4.4 Phase 4: Production Configuration and Engine Customization
...
## 5. Performance Engineering & Quality Optimization Specification
...
### 5.1 VRAM Memory Partitioning (`gpu_mem=256`)
...
### 5.2 Network Stack and Socket Buffer Optimization
...
### 5.3 Wireless Power Management Deactivation
...
## 6. Operational Manual and Verification Procedures
...
## 7. Fault Analysis and Troubleshooting Matrix
...
## 8. Appendix: Quick Installation Guide (3-Minute Setup)
...
# 4. Apply high-fidelity production settings
sed -i 's/player_select = .*/player_select = 2/' ~/lazycast_setup/lazycast/d2.py
sed -i 's/disable_1920_1080_60fps = .*/disable_1920_1080_60fps = 1/' ~/lazycast_setup/lazycast/d2.py
sed -i 's/sound_output_select = .*/sound_output_select = 0/' ~/lazycast_setup/lazycast/d2.py
