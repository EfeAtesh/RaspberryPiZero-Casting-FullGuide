...
# 4. Build Userland OpenMAX Libraries
...
# 6. Apply Production Quality Settings (Player 2 + HDMI Audio)
...
# 7. Generate Responsive 40dp Standby Wallpaper
...
# 9. Apply Network & Power Tweaks
sudo sysctl -w net.core.rmem_max=26214400
sudo sysctl -w net.core.rmem_default=26214400
sudo iwconfig wlan0 power off 2>/dev/null || true

echo "=== Installation Completed Successfully! (•̀ᴗ•́)و ̑̑ ==="
echo "Your Raspberry Pi will now automatically boot into the Wireless Display Receiver!"
